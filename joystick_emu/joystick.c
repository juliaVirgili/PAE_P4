...
//setter per actualitzar l'estat Anterior
void Set_estado_anterior(uint8_t valor){
	Anterior = valor;
}

//setter segons la tecta del teclat que es premi
void Set_estado_actual(uint8_t valor){
	Estado_actual = valor;
}

//getter de l'estat en que es troba el joystick
//escriu en les variables l'estat actual i anterior per a poder ser usades fora
